      ...
      py-5 md:py-10'>
        <div className="wrapper grid grid-cols-1 gap-5 md:grid-cols-2 2xl:gap-0">
          <div className='flex flex-col justify-center gap-8'>
            <h1 className='h1-bold'>Host, Connect, Celebrate: Your Gaming Events, Our Platform!</h1>
            <p className='p-regular-20 md:p-regular-24'>Create and engage in gaming events hosted by our global community.</p>
          ...
          <Image src="/assets/images/hero-h.jpg"
          alt="hero"
          width={1000}
          height={1000}
          id="hero-h"
